...
public class Simulation {
   ...
   public static void main(String[] args) {
      ...
      // création des connexions sur l'opérateur fixe
      ...
      // création des connexions sur l'opérateur variable
      ...
      // déconnexion des premières connexions de chaque opérateur
      // op fixe
      ...
      // création de 2 nouvelles "premières connexion"
      try {
